# Домашнее задание к занятию "`SQL. Часть 2`" - `Ганопольский Евгений`
...
![Задание 1](https://github.com/Tolstevich/ganopolskiy_netology/blob/master/rnd-04/img/1.png)

Задание 2

Получите количество фильмов, продолжительность которых больше средней продолжительности всех фильмов.

![Задание 2](https://github.com/Tolstevich/ganopolskiy_netology/blob/master/rnd-04/img/2.png)

Задание 3

Получите информацию, за какой месяц была получена наибольшая сумма платежей, и добавьте информацию по количеству аренд за этот месяц.

![Задание 3](https://github.com/Tolstevich/ganopolskiy_netology/blob/master/rnd-04/img/3.png)
